...
//        }
//        if let member = open(self.storage) {
//            let path = keyPath.appending(path: \.[default: member])
//            return Shared<Member>(self.storage, keyPath: self.keyPath.appending(path: path)!)
//        }
//        return nil
//    }
//    
